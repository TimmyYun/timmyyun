    ...
    <header className="w-auto max-w-full p-0 min-w-fit h-fit mx-72 flex flex-row flex-auto items-center my-8 justify-between font-inter">
      ...
      <div className="self-auto flex w-28 rounded-lg text-base text-white">
        ...
        >
          <svg
            ...
            x="0px"
            y="0px"
            viewBox="0 0 454.38 454.38"
            style={{ enableBackground: "new 0 0 454.38 454.38" }}
            fill="currentColor"
            aria-hidden="true"
          >
            <path
              d="M426.247,293.325l-7.95-91.867c-1.397-16.198-7.079-31.599-16.472-44.807c9.132-50.936-6.278-102.363-45.987-153.191
		...
		C410.178,316.37,402.496,337.447,387.236,352.707z"
            />
            <path
              d="M277.202,245.501c-10.42-17.58-29.584-28.5-50.012-28.5c-10.084,0-20.04,2.64-28.782,7.629
		...
		C287.67,298.524,289.278,309.056,286.881,319.203z"
            />
            <path
              d="M168.075,237.001c4.821,0,8.814-3.82,8.988-8.678c0.178-4.967-3.704-9.138-8.672-9.316l-27.892-1
		...
		C167.857,236.999,167.966,237.001,168.075,237.001z"
            />
            <path
              d="M313.881,218.006l-27.892,1c-4.968,0.178-8.85,4.349-8.672,9.316c0.174,4.858,4.167,8.678,8.988,8.678
      ...
      <div className="relative hidden lg:flex items-center ml-auto">
        ...
        <div className="flex items-center border-l border-slate-200 ml-6 pl-6 dark:border-slate-800">
          ...
          >
            <span className="sr-only">Connect in GitHub</span>
            <svg
              viewBox="0 0 16 16"
              className="w-5 h-5"
              fill="currentColor"
